...
namespace Microsoft.Extensions.Logging {
    /// <summary>
    /// Formatter to convert the named format items like {NamedformatItem} to <see cref="Microsoft.SqlServer.Server.Format"/> format.
    /// </summary>
        ...
        public LogValuesFormatter(string format) {
            ...
            while (scanIndex < endIndex) {
                ...
                if (closeBraceIndex == endIndex) {
                    ...
                    int formatDelimiterIndex = format.Substring(openBraceIndex, closeBraceIndex - openBraceIndex).IndexOfAny(new char[]{',', ':'});
